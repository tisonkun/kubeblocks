...
//+kubebuilder:webhook:path=/mutate-apps-kubeblocks-io-v1-componentversion,mutating=true,failurePolicy=fail,sideEffects=None,groups=apps.kubeblocks.io,resources=componentversions,verbs=create;update,versions=v1,name=mcomponentversion.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-apps-kubeblocks-io-v1-componentversion,mutating=false,failurePolicy=fail,sideEffects=None,groups=apps.kubeblocks.io,resources=componentversions,verbs=create;update,versions=v1,name=vcomponentversion.kb.io,admissionReviewVersions=v1
