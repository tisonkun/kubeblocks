...
//+kubebuilder:webhook:path=/mutate-apps-kubeblocks-io-v1-componentdefinition,mutating=true,failurePolicy=fail,sideEffects=None,groups=apps.kubeblocks.io,resources=componentdefinitions,verbs=create;update,versions=v1,name=mcomponentdefinition.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-apps-kubeblocks-io-v1-componentdefinition,mutating=false,failurePolicy=fail,sideEffects=None,groups=apps.kubeblocks.io,resources=componentdefinitions,verbs=create;update,versions=v1,name=vcomponentdefinition.kb.io,admissionReviewVersions=v1
